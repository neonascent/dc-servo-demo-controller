...
void speed(int theValue) {
  println("Speed: "+theValue);
  myPort.write("S"+theValue);
  delay(50);
}
...
void position(int theValue) {
  println("Position: "+theValue);
  myPort.write("G"+theValue); 
  delay(50);
}
